function [] =run_Run_ODE_4dvar_multiple_collocation(SeedNum,DATAFLAG,modeldata,ODEmodel,varargin)
if nargin>4
...
%Kinactivation=1;
%dt_col=.1;
Run_ODE_4dvar_with_collocation(SeedNum,DATAFLAG,struct('MethodToUse'...
