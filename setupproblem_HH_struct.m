function [probinfo,upperbound,lowerbound,guess, tau] = setupproblem_HH_struct(vdata,tdata,Iappdata,dtmodel,paramdetails,Qinv,Rinv,parambounds,pest_ind,numintervals,problemFlags,probinfo,varargin)
...
assert(mod(StepsPerObs,1)==0, '%s: Data and model should have integer time difference ratio');
